  ...
  return (
    <div className='w-screen bg-[#F5EEE9] xl:h-[40rem] '>
      ...
      <div className=' sm:flex flex-col lg:pb-10  '>
        <h1 className="Graphik text-[2.4rem] font-extrabold leading-tight sm:text-center  self-center sm:w-full lg:text-start lg:[&>*]:inline lg:pr-35 xl:text-6xl xl:pr-20">
      ...
      {/* right-section-image */}
      <div className='bg-[url(https://lexend-nextjs.vercel.app/assets/images/template/hero-mockup.png)] bg-cover  '> 
